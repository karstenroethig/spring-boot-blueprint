...
import karstenroethig.springbootblueprint.webapp.util.validation.ValidationMessage;
import karstenroethig.springbootblueprint.webapp.util.validation.ValidationState;
